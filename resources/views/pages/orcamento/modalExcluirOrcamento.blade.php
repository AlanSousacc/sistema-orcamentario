<div id="delete" class="modal fade text-danger" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="{{route('orcamento.destroy', 'id')}}" method="post">
				{{method_field('delete')}}
				{{ csrf_field() }}
				<div class="modal-body">
					<p class="text-center">Você tem certeza que deseja excluir este orçamento?</p>
					<p class="text-center">Caso clique em Sim, não será possível recupera-lo!</p>
					<input type="hidden" name="orcamento_id" id="contid" value="">
				</div>
